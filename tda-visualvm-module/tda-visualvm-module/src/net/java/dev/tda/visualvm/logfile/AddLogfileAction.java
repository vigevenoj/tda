...
public class AddLogfileAction extends SingleDataSourceAction<LogfileDataSource> {
    ...
    private static final String ICON_PATH = "net/java/dev/tda/visualvm/resources/logfileadd.gif";    // NOI18N
    ...
    private AddLogfileAction() {
        ...
        putValue(NAME, NbBundle.getMessage(TDAView.class, "LBL_Add_Logfile"));  // NOI18N
        putValue(SHORT_DESCRIPTION, NbBundle.getMessage(TDAView.class, "ToolTip_Add_Logfile")); // NOI18N
    }
