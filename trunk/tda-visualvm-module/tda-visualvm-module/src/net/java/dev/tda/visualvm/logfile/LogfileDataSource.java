 ...
 *
 * $Id: LogfileDataSource.java,v 1.1 2008-04-27 20:32:34 irockel Exp $
 */
...
public class LogfileDataSource extends DataSource {
    ...
    private static class LogfileDataSourceDescriptor extends DataSourceDescriptor {
        private static final Image NODE_ICON = Utilities.loadImage("net/java/dev/tda/visualvm/resources/logfiles.gif", true);    // NOI18N

        LogfileDataSourceDescriptor() {
            super(LogfileDataSource.sharedInstance(), NbBundle.getMessage(TDAView.class, "ExplorerNode_Name_Logfiles"), null, NODE_ICON, 20, EXPAND_ON_EACH_NEW_CHILD);   // NOI18N
        }
